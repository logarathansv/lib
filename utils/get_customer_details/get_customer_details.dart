                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      foregroundColor: const Color(0xFF2f4757),
                      backgroundColor: const Color(0xFFF4C345), // Text color
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      decoration: InputDecoration(
        labelText: label,
        labelStyle: const TextStyle(color: Color(0xFF028F83)),
        filled: true,
        fillColor: Colors.white,
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10),
          borderSide: const BorderSide(color: Color(0xFF028F83)),
        ),
      ),
      validator: validator,
      onSaved: onSaved,
